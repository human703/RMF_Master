# -*- coding: utf-8 -*-
"""
Created on Wed Jun  3 17:09:00 2026
...
ax.plot(kf_list,BE_basic_list, label="Basic")
ax.plot(kf_list,BE_self_int_list, label="Self-interaction")
...
ax1.plot(kf_list, m_star_self_int_list, label="Including self interactions")
